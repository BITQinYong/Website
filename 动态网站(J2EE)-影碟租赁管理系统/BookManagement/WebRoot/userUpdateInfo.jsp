...
<%
		...
		try {
			resultSet.next();
%>
 					<form name="form" method="post" action="/BookManagement/UserUpdateInfoServlet">
...
%>
								...
								<li style="display:block">Email：<input type="text" name="userEmail" value=<%= resultSet.getString("userEmail") %>></input>（用于找回密码）&nbsp;&nbsp;&nbsp;&nbsp;<% if(request.getAttribute("userEmailError")!=null){ %><%= (String)request.getAttribute("userEmailError") %><% } %></li>
								<li style="display:block;margin-top:20px;"><input type="submit" name="Submit" value="提交" >     <a href="/BookManagement/index.jsp">返回</a></li>
<%
