 		...
 		<div class="mainbox">
			<div class="left">
  			...
  			<div class="right">
				...
				<div class="rightmid">
					<div style="text-align:center"><h3>用户登录</h3></div>
						<form name="form1" method="post" action="/BookManagement/UserLoginServlet">
							<div class="title">
								<div class="datainfo">
									<ul style="float:left;width:35%;display:inline;">
										<li><% if(request.getAttribute("userLoginError")!=null){ %><%= (String)request.getAttribute("userLoginError") %><% } %></li>
										<li>帐号：<input name="userID" type="text" id="id"></li>
										<li>密码：<input name="userPassword" type="password" id="password"></li>
									</ul>
